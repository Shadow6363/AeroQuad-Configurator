...
class Ui_vehicleConfiguration(object):
    def setupUi(self, vehicleConfiguration):
        vehicleConfiguration.setObjectName('vehicleConfiguration')
        vehicleConfiguration.resize(589, 304)
        vehicleConfiguration.setStyleSheet('')
        ...
        self.configView.setStyleSheet('background-color:  qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0.0397727, stop:0 rgba(12, 57, 106, 255), stop:1 rgba(25, 134, 193, 255))')
        self.configView.setText('')
        ...
        self.configSpecs.setStyleSheet('background-color:  qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0.0397727, stop:0 rgba(100, 100, 100, 255), stop:1 rgba(36, 36, 36, 255))\n'
'')
        ...
        self.configSpecs.setObjectName('configSpecs')
